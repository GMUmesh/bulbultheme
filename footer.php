<footer class="footer">
    <?php if( is_active_sidebar( 'spark_blog-footer-left' ) ||
    ...
    <div class="ct-credits">
      ...
      <span class="footer-info-right">
        <?php echo esc_html__(' | Designed by', 'spark-news') ?> <a href="<?php echo esc_url('https://umeshghartimagar.com.np/', 'spark-news'); ?>"><?php echo esc_html__('Umesh GM', 'spark-news') ?></a>
      </span></p>
    </div>
</footer>
<?php wp_footer(); ?>
